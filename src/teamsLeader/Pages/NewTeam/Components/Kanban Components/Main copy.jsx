                        ...
                        >
                          {(provided) => (
                            <div
                              ...
                              ref={provided.innerRef}
                              className="bg-white mb-2 rounded border h-32 p-2 text-xs text-gray-500 flex flex-col gap-1"
                            >
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span>Due Date</span>
                                <span className="due-date-box bg-gray-100 flex-1 h-8 rounded flex items-center  ">
                                  <div className="w-full flex items-center justify-center gap-1 icons-due-date hidden m-1 p-1">
